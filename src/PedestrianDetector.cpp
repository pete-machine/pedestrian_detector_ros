...
PedestrianDetector::PedestrianDetector(string strPedModel){
...
vector<bbType> PedestrianDetector::nmsMax(vector<bbType> bbs, float overlap) {
	...
	sort(bbsSorted.begin(), bbsSorted.end(), by_score());
...
void PedestrianDetector::loadMatFile(string strPedModel){
